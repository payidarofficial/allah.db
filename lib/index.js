...
// src/Providers/Yaml.ts
var import_fs4 = require("fs");
var import_yaml2 = __toESM(require("yaml"));
var YamlDatabase = class {
  constructor({ path = "./database.yaml" } = {}) {
    ...
    if (!(0, import_fs4.existsSync)(path))
      allah(this.data, this.path, false);
    this.data = import_yaml2.default.parse(ikraFile(this.path));
    if (!this.data)
      this.data = {};
  }
  hicret(firavun, musa) {
